...
Route::post('index/view', 'StudentsController@store');
Route::get('index/{id}/delete', 'StudentsController@delete');
Route::get('index/view', 'StudentsController@view');
Route::get('index/{id}/edit', 'StudentsController@showEdit');
Route::post('index/view/{id}', 'StudentsController@edit');